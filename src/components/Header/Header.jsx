...
const Header = () => {
  ...
  return (
    <div className="w-full h-16  p-4 relative">
        <button  onClick={handleClick} className="flex flex-col fixed z-10 items-left p-2 justify-center gap-1 w-14 h-14 rounded-2xl bg-[#c25cd8] text-white focus:outline-none">
        ...
        {ativo && <motion.div  initial={{ height: 0, width:0, opacity: 0 }}
            ...
            className= {`absolute top-4 left-4  md:top-5 md:left-16  md:bg-transparent w-auto md:w-screen z-0 ${ativo ? "" : " hidden"}`}>
            <ul className={`flex flex-col md:flex-row fixed bg-black rounded-lg flex-wrap md:bg-transparent rounded-4xl p-2 text-white font-bold`}>
                <li><a href="#" className="mt-16 md:mt-0 block px-4 py-2 md:hover:text-[#f8b500]">CAPA</a></li>
                <li><a href="#" className="block px-4 py-2 md:hover:text-[#f8b500]">LANÇAMENTOS</a></li>
                <li><a href="#" className="block px-4 py-2 md:hover:text-[#f8b500]">DISCOGRAFIA</a></li>
                <li><a href="#" className="block px-4 py-2 md:hover:text-[#f8b500]">AGENDA</a></li>
                <li><a href="#" className="block px-4 py-2 md:hover:text-[#f8b500]">CARREIRA</a></li>
                <li><a href="#" className="block px-4 py-2 md:hover:text-[#f8b500]">CONTATO</a></li>
            </ul>
        </motion.div>}
